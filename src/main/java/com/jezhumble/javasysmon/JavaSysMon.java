...
public class JavaSysMon implements Monitor {
    ...
    /**
     * Get the stats process table. This call returns an array of
    ...
    /**
     * Gets the stats process table in the form of a process tree.
     ...
     *
     * @return The stats process table in the form of a process tree.
     */
