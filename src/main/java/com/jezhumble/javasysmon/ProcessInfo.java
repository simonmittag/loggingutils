...
public class ProcessInfo {
     ...
     * On Mac OSX this information is only available for the stats process.
     *
     ...
     * memory. On Mac OSX this information is only available for the stats
     * process.
     *
     ...
     * is only available for the stats process.
     *
